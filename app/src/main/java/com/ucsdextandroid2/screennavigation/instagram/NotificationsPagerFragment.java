...
public class NotificationsPagerFragment extends Fragment {
    ...
    private NotificationsPagerAdapter adaper;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (adaper == null)
            adaper = new NotificationsPagerAdapter(this);
    }
    ...
    public void onViewCreated(@NonNull View view,
        ...
        viewPager2.setAdapter(adaper);

        tabMediator = new TabLayoutMediator(
                tabLayout, viewPager2, (tab, position) -> tab.setText(adaper.getTitle(position))
        );
        tabMediator.attach();
    }
...
class NotificationsPagerAdapter extends FragmentStateAdapter {
